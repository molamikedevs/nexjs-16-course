...
export default function Stats({ totalQuestions, totalAnswers, badges, reputationPoints }: Props) {
  return (
    <div className="mt-10">
      <h4 className="h3-semibold text-dark200_light900">
        Stats &amp; Badges · <span>{formatNumber(reputationPoints)} Reputation Points</span>
      </h4>
